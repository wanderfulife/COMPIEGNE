...
const pageTitle = ref('COMPIEGNE'); // Browser tab title
...
Bonjour,</p> pour mieux connaître les usagers de la gare de Compiègne,</p> La SNCF souhaiteraient en savoir plus sur votre déplacement en cours.</p> Auriez-vous quelques secondes à nous accorder ? 
